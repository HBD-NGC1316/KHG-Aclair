...
## Dictionary to store user and item encodin
user_dic = dict() 
item_dic = dict()
## Dictionary to collect items per user
ui_dic = dict()
ss = set()
with open("./data/amazon-book/user_item/item_enc.txt", "w") as out_item:
    with open("./data/amazon-book/user_item/ratings_s.txt", "r") as rat_f:
        with open("./data/amazon-book/user_item/ratings_s_enc.txt", "w") as out:
            user_id = 1
            item_id = 1
...
i2ent_dic = dict()
with open("./data/amazon-book/item_entity/arr_ab2fb_s.txt", "r") as mlfb_f:
    for line in mlfb_f:
        line = line.strip().split("\t")
...
i2encode_dic = dict()
max_item = 1
with open("./data/amazon-book/user_item/item_enc.txt", "r") as rat_encode_f:
