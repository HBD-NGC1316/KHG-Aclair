...
with open("./data/amazon-book/item_entity/arr_ab2fb.txt", "r") as ml_file:
    ## 1	m.0dyb1
    ml_dic = dict()
    item_list1 = set()
...
with open("./data/amazon-book/user_item/ratings.txt", "r") as ui_file:
    item_list2 = set()
...
it_set=set()
with open('./data/amazon-book/graph/graph_book_1step.txt', 'r', encoding='utf-8') as i_file:
...
with open('./data/amazon-book/graph/graph_book_1step.txt', 'r', encoding='utf-8') as ii_file:
    with open('./data/amazon-book/graph/graph_book_1step_v1.2.txt', 'w', encoding='utf-8') as o_file:
...
arr_item_set = set()
with open("./data/amazon-book/item_entity/arr_ab2fb_s.txt", "w") as ml_out:
    for key in ml_dic:
...
rating_item_set = set()
with open("./data/amazon-book/user_item/ratings_s.txt", "w") as ui_out:
    with open("./data/amazon-book/user_item/ratings.txt", "r") as ui_file:
        for line in ui_file:
