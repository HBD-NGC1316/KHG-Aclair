...
class Main:
    def run(self):
        ...
        input_file_list = os.listdir("./data/amazon-book/graph/hkg")
        not_split = []
        ...
        for f in input_file_list:
            with open("./data/amazon-book/graph/hkg/"+f, "r") as input_f:
        ...
        with open("./data/amazon-book/graph/hkg/rel_cardi.txt", "w") as out:
        ...
        for f in input_file_list:
            with open("./data/amazon-book/graph/hkg/cardi_"+f, "w") as output_f:
                with open("./data/amazon-book/graph/hkg/"+f, "r") as input_f:
                    for line in tqdm(input_f):
        ...
        hkg_item = set()
        for f in input_file_list:
            with open("./data/amazon-book/graph/hkg/cardi_"+f, "r") as output_f:
        ...
        item_list = set()
        with open("./data/amazon-book/user_item/ratings_s_enc.txt", "r") as ui_file:
            with open("./data/amazon-book/user_item/cardi_ratings_s_enc.txt", "w") as out_file:
        ...
        cnt = 1
        with open("./data/amazon-book/user_item/cardi_ratings_s_enc.txt", "r") as ds:
            lines = ds.readlines()
            with open("./data/amazon-book/user_item/final_ratings.txt", "w") as output:
        ...
        with open("./data/amazon-book/graph/hkg/cardi_enc_HKG_ab_a.txt", "r") as new_hkg:
            with open("./data/amazon-book/graph/hkg/final_HKG.txt", "w") as new_output:
